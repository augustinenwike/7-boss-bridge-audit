...
contract L1BossBridge is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public DEPOSIT_LIMIT = 100_000 ether; // e depositing tokens you cant do too many
     ...
     */
    //  @audit-high
    // if a user aproves the bridge any other user can steal their funds
    ...
    function sendToL1(uint8 v, bytes32 r, bytes32 s, bytes memory message) public nonReentrant whenNotPaused {
        ...
        // q slither said this is bad is that okay
